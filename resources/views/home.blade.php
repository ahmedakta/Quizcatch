...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="{{asset('homepage/documentation/img/favicon.png')}}">
    <link rel="apple-touch-icon" sizes="57x57" href="{{asset('homepage/documentation/img/apple-touch-icon-57x57.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('homepage/documentation/img/apple-touch-icon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('homepage/documentation/img/apple-touch-icon-114x114.png')}}">
    ...
    <!-- Bootstrap CSS -->
    <link href="{{asset('homepage/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" />
    
    <!-- CSS Files For Plugin -->
    <link href="{{asset('homepage/documentation/css/animate.css')}}" rel="stylesheet">
    <link href="{{asset('homepage/documentation/css/font-awesome/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('homepage/documentation/css/magnific-popup.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/css/YTPlayer.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/inc/owlcarousel/css/owl.carousel.min.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/inc/owlcarousel/css/owl.theme.default.min.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/inc/revolution/css/settings.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/inc/revolution/css/layers.css')}}" rel="stylesheet" />
    <link href="{{asset('homepage/documentation/inc/revolution/css/navigation.css')}}" rel="stylesheet" />
    
    <!-- Custom CSS -->
    <link href="{{asset('homepage/documentation/css/style.css')}}" rel="stylesheet">
  ...
  <body class="homepage_slider" data-spy="scroll" data-target=".navbar-fixed-top" data-offset="100">
                        ...
                        <div class="navbar-header">
                            ...
                            <div class="logo-container">
                                <div class="logo-wrap local-scroll">
                                  <a href="#home">
                                    <img class="logo" src="{{asset('homepage/documentation/img/logo.png')}}" alt="logo" data-rjs="2">
                                  </a>
                                </div>
                            </div>
          ...
          <div class="rev_slider fullscreenbanner" id="rev_slider_nagency" style="display:none;">
              <ul style="display:none;">
                ...
                <li data-index="rs-1" data-transition="fadetotopfadefrombottom" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-rotate="0"  data-saveperformance="off"  data-title="N.Agency" data-description="">
                  <img src="{{asset('homepage/documentation/img/slider/s1.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  ...
                  <div class="tp-caption NotGeneric-Title tp-resizeme white-color rs-parallaxlevel-3" 
                    ...
                    style="z-index: 5; white-space: nowrap;">Welcome to n. Agency
                  </div>
                  ...
                  <div class="tp-caption NotGeneric-SubTitle tp-resizeme white-color rs-parallaxlevel-4" 
                    ...
                    data-splitout="none" 
                    data-responsive_offset="on"                     
                    style="z-index: 6; white-space: nowrap;">#1 digital solution in the city
                  </div>
                ...
                <li data-index="rs-3" data-transition="slideremoveright" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-rotate="0"  data-saveperformance="off">
                  <img src="{{asset('homepage/img/slider/s3.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
        ...
        <div class="container">
            ...
            <div class="portfolio portfolio-isotope col-3 gutter">
                ...
                <div class="pf-item branding">
                    <a href="{{asset('homepage/documentation/img/portfolio/1.jpg')}}" class="pf-style lightbox-image mfp-image">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/1.jpg')}}" alt="">
                            <div class="overlay">
                ...
                <div class="pf-item graphic webdesign">
                    <a href="{{asset('homepage/documentation/img/portfolio/2.jpg')}}" class="pf-style lightbox-image mfp-image">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/2.jpg')}}" alt="">
                            <div class="overlay">
                                <div class="overlay-caption">
                                    <div class="overlay-content">
                                        <div class="pf-info white-color">
                ...
                <div class="pf-item video webdesign">
                    <a href="https://www.youtube.com/watch?v=6D-A6CL3Pv8" class="pf-style lightbox-video mfp-iframe">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/3.jpg')}}" alt="">
                            <div class="overlay">
                                <div class="overlay-caption">
                                    <div class="overlay-content">
                                        <div class="pf-info white-color">
                ...
                <div class="pf-item video webdesign">
                    <a href="https://www.youtube.com/watch?v=6D-A6CL3Pv8" class="pf-style lightbox-video mfp-iframe">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/4.jpg')}}" alt="">
                            <div class="overlay">
                                <div class="overlay-caption">
                                    <div class="overlay-content">
                                        <div class="pf-info white-color">
                ...
                <div class="pf-item branding graphic">
                    <a href="{{asset('homepage/documentation/img/portfolio/5.jpg')}}" class="pf-style lightbox-image mfp-image">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/5.jpg')}}" alt="">
                            <div class="overlay">
                                <div class="overlay-caption">
                                    <div class="overlay-content">
                                        <div class="pf-info white-color">
                ...
                <!-- Portfolio Item -->
                <div class="pf-item branding graphic">
                    <a href="{{asset('homepage/documentation/img/portfolio/6.jpg')}}" class="pf-style lightbox-image mfp-image">
                        <div class="pf-image">
                            <img src="{{asset('homepage/documentation/img/portfolio/6.jpg')}}" alt="">
                            <div class="overlay">
                                <div class="overlay-caption">
                                    <div class="overlay-content">
                                        <div class="pf-info white-color">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="feature-image">
                        <img src="{{asset('homepage/documentation/img/sample1.png')}}" alt="Feature Image" class="img-responsive wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.6s" />
                    </div>                  
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 p-bottom-30">
                    <div class="team-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                        <div class="team-item-image">
                            ...
                            <img src="{{asset('homepage/documentation/img/team/1.jpg')}}" alt="" />
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 p-bottom-30">
                    <div class="team-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                        <div class="team-item-image">
                            ...
                            <img src="{{asset('homepage/documentation/img/team/2.jpg')}}" alt="" />
                        </div>
                        <div class="team-item-info">
                            <div class="team-item-name">
                                Laura Doe
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 p-bottom-30">
                    <div class="team-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                        <div class="team-item-image">
                            ...
                            <img src="{{asset('homepage/documentation/img/team/3.jpg')}}" alt="" />
                        </div>
                        <div class="team-item-info">
                            <div class="team-item-name">
                                Andy Doe
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 p-bottom-30">
                    <div class="team-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                        <div class="team-item-image">
                            ...
                            <img src="{{asset('homepage/documentation/img/team/4.jpg')}}" alt="" />
                        </div> <!-- /.team-item-image -->
                        <div class="team-item-info">
                            <div class="team-item-name">
                                Inani Joe
                ...
                <div id="owl-blog" class="owl-carousel owl-theme">
                    ...
                    <div class="blog wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-media">
                            <a  href="blog_single_post.html"><img src="{{asset('homepage/img/blog/b1.jpg')}}" alt=""></a>
                        </div><!--post media-->
                    ...
                    <div class="blog wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-media">
                            <a  href="blog_single_post.html"><img src="{{asset('homepage/documentation/img/blog/b2.jpg')}}" alt=""></a>
                        </div><!--post media-->
                    ...
                    <div class="blog wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-media">
                            <a  href="blog_single_post.html"><img src="{{asset('homepage/documentation/img/blog/b3.jpg')}}" alt=""></a>
                        </div><!--post media-->
                    ...
                    <div class="blog wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-media">
                            <a  href="blog_single_post.html"><img src="{{asset('homepage/documentation/img/blog/b4.jpg')}}" alt=""></a>
                        </div><!--post media-->
            ...
            <div class="row">
                ...
                <div id="owl-clients" class="owl-carousel owl-theme client text-center">
                        ...
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/1.png')}}" alt="">
                        </div>

                        <!-- === Client 2 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/2.png')}}" alt="">
                        </div>

                        <!-- === Client 3 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/3.png')}}" alt="">
                        </div>

                        <!-- === Client 4 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/4.png')}}" alt="">
                        </div>

                        <!-- === Client 5 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/5.png')}}" alt="">
                        </div>

                        <!-- === Client 6 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/6.png')}}" alt="">
                        </div>

                        <!-- === Client 7 === -->
                        <div class="client-item text-center">
                            <img class="img-responsive" src="{{asset('homepage/documentation/img/client/7.png')}}" alt="">
                        </div>
    ...
    <!-- jQuery -->
    <script src="{{asset('homepage/documentation/js/jquery.min.js')}}"></script>
    
    <!-- Bootstrap -->
    <script src="{{asset('homepage/documentation/bootstrap/js/bootstrap.min.js')}}"></script>
    
    <!-- Components Plugin -->
    <script src="{{asset('homepage/documentation/js/jquery.easing.1.3.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/smooth-scroll.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/jquery.appear.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/js/jquery.countTo.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/jquery.stellar.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/jquery.magnific-popup.min.j')}}s"></script>
    <script src="{{asset('homepage/documentation/js/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/jquery.mb.YTPlayer.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/retina.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/js/wow.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/owlcarousel/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>

    <!-- Contact Form -->
    <script src="{{asset('homepage/documentation/js/contact.js')}}"></script>
    
    <!-- Custom Plugin -->
    <script src="{{asset('homepage/documentation/js/custom.js')}}"></script>

    <!-- RS Plugin Extensions -->
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.carousel.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.actions.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.navigation.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.migration.min.js')}}"></script>
    <script src="{{asset('homepage/documentation/inc/revolution/js/extensions/revolution.extension.parallax.min.js')}}"></script>
